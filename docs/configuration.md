...
| Setting | Type | Default | Description |
| --- | --- | --- | --- |
| `ghost.requestTimeLimitMinutes` | integer; min 1; max 1440 | `15` | Maximum minutes a Ghost agent request may run, including tool rounds. This is the safety budget, not the provider HTTP timeout. |
