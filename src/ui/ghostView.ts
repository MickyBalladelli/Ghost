  ...
  <head>
    ...
    <style nonce="${nonce}">
      ...
      * {
      ...
      .history-search-row #history-search {
        flex: 1;
        min-width: 0;
        width: auto;
      }
      ...
      .history-search-row label input {
        margin: 0;
      }
      ...
      .search-hit {
        animation: search-hit 1.6s ease-out;
      }

      @keyframes search-hit {
        0%, 100% { outline: 0 solid transparent; }
        20% { outline: 2px solid var(--vscode-focusBorder); outline-offset: 3px; }
      }
      ...
      .tool-timeline.tool-success {
        border-left-color: var(--vscode-testing-iconPassed, #73c991);
      }

      .tool-timeline.tool-failure {
        border-left-color: var(--vscode-editorWarning-foreground, #cca700);
      }
      ...
      .tool-timeline-items .tool-progress {
        border-left: 0;
      }
