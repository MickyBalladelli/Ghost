...
const createAppShell = (iconUri: string): HTMLDivElement => {
  ...
  const composer = createElement('form', { className: 'composer', id: 'composer' }, [
    ...
    createElement('div', { className: 'composer-footer' }, [createElement('span', { className: 'composer-hint', id: 'composer-hint' }, ['Enter to send · Shift+Enter for a new line · ↑/↓ prompt history']), createElement('span', { className: 'composer-count', id: 'composer-count' }, ['0 chars · ~0 tokens']), createElement('span', { className: 'persistence-status', id: 'persistence-status', role: 'status', 'aria-live': 'polite', 'aria-atomic': 'true' }), button('stop', 'Stop', { className: 'stop-button', hidden: true }), select('mode', [option('agent', 'Agent — implement changes'), option('ask', 'Ask'), option('edit', 'Edit'), option('explain', 'Explain')], { className: 'workflow-mode-select', 'aria-label': 'Workflow mode', title: 'Workflow mode' }), button('send', 'Send', {}, []), createElement('span', { className: 'prompt-history-actions', 'aria-label': 'Prompt history' }, [button('search-prompt-history', '⌕', { className: 'secondary prompt-history-button', 'aria-label': 'Search prompt history', title: 'Search prompt history' }), button('previous-prompt', '↑', { className: 'secondary prompt-history-button', 'aria-label': 'Previous prompt' }), button('next-prompt', '↓', { className: 'secondary prompt-history-button', 'aria-label': 'Next prompt' })])])
  ])
