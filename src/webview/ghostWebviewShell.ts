...
const createAppShell = (iconUri: string): HTMLDivElement => {
  ...
  const controls = createElement('section', { className: 'control-strip', 'aria-label': 'Prompt controls' }, [
    ...
    createElement('span', { className: 'model-profile-effective', id: 'model-profile-effective', 'aria-live': 'polite' }),
    createElement('span', { className: 'model-capabilities', id: 'model-capabilities', 'aria-live': 'polite', 'aria-atomic': 'true' }),
  ...
  const composer = createElement('form', { className: 'composer', id: 'composer' }, [
    ...
    createElement('div', { className: 'composer-footer' }, [createElement('span', { className: 'composer-hint', id: 'composer-hint' }, ['Enter to send · Shift+Enter for a new line · ↑/↓ prompt history']), createElement('span', { className: 'composer-count', id: 'composer-count' }, ['0 chars · ~0 tokens']), createElement('span', { className: 'persistence-status', id: 'persistence-status', role: 'status' }), createElement('span', { className: 'prompt-history-actions', 'aria-label': 'Prompt history' }, [button('search-prompt-history', '⌕', { className: 'secondary prompt-history-button', 'aria-label': 'Search prompt history', title: 'Search prompt history' }), button('previous-prompt', '↑', { className: 'secondary prompt-history-button', 'aria-label': 'Previous prompt' }), button('next-prompt', '↓', { className: 'secondary prompt-history-button', 'aria-label': 'Next prompt' })]), button('stop', 'Stop', { className: 'stop-button', hidden: true }), button('send', 'Send', {}, [])])
  ])
  const chat = createElement('div', { className: 'chat-layout' }, [createElement('main', { className: 'chat-main' }, [createElement('section', { className: 'messages', id: 'messages', role: 'log', 'aria-label': 'Conversation messages', 'aria-live': 'polite' }), createElement('div', { className: 'screen-reader-status', id: 'screen-reader-status', role: 'status', 'aria-live': 'polite' }), composer, createElement('footer', { className: 'status-footer', id: 'status-footer' }, [ghostFace(iconUri, 'thinking-ghost ghost-face'), createElement('span', { className: 'status-dot', 'aria-hidden': 'true' }), createElement('span', { id: 'status-text' }, ['Ready'])])])])
  ...
  const quickContent = createElement('div', { className: 'modal-scroll' }, [createElement('p', { className: 'modal-description' }, ['Change provider or model without opening full settings.']), createElement('div', { className: 'quick-switch-grid' }, [label('Provider', 'quick-provider'), select('quick-provider', providerOptions), label('Model', 'quick-model'), select('quick-model', [])]), createElement('section', { className: 'diagnostic-card', 'aria-label': 'Connection diagnostics' }, [createElement('strong', { id: 'quick-connection-status' }, ['Checking…']), createElement('p', { id: 'quick-connection-details', className: 'modal-description' })])])
  const setupContent = createElement('div', { className: 'modal-scroll' }, [createElement('p', { className: 'modal-description' }, ['Check your local provider before your first request. Ghost stays local unless you choose an external endpoint.']), createElement('div', { className: 'setup-check' }, [createElement('strong', {}, ['1. Provider']), createElement('span', { id: 'setup-provider-status' }, ['Checking…']), button('setup-check-provider', 'Check provider', { className: 'secondary' })]), createElement('div', { className: 'setup-check' }, [createElement('strong', {}, ['2. Models']), createElement('span', { id: 'setup-model-status' }, ['Waiting for model list…']), createElement('div', { className: 'setup-model-list', id: 'setup-model-list' })]), createElement('div', { className: 'setup-check' }, [createElement('strong', {}, ['3. Test request']), createElement('span', { id: 'setup-test-status' }, ['Optional: send one small request to verify generation.']), button('setup-test-request', 'Run test request')]), createElement('div', { className: 'setup-capabilities', id: 'setup-capabilities' })])
  const historyContent = createElement('div', { className: 'modal-scroll' }, [createElement('p', { className: 'modal-description' }, ['Choose a previous conversation to continue.']), createElement('div', { className: 'history-search-row' }, [input('history-search', 'search', { placeholder: 'Search conversations and messages', 'aria-label': 'Search conversation history and messages' }), createElement('label', {}, [input('history-bookmarks-only', 'checkbox'), ' Bookmarks only'])]), createElement('p', { className: 'modal-description', id: 'history-search-summary', 'aria-live': 'polite' }), createElement('div', { className: 'history-list', id: 'history-list' })])
